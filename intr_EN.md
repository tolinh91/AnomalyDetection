...
![Bảng 3. Tóm tắt các phương pháp phát hiện bất thường dựa trên dự đoán.](source/Table3.jfif)
...
![Tổng quan về các phương pháp autoencoder để phát hiện bất thường trong chuỗi thời gian](source/AutoEncoder.jfif)
...
![Tổng quan về các phương pháp GAN để phát hiện bất thường trong chuỗi thời gian](source/GAN.jfif)
